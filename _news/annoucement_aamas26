...
Looking very much forward to be at Cyprus for [AAMAS 2026](https://cyprusconferences.org/aamas2026/).

If you are around make sure to pass by the talks from our lab!

In the workshops:
- [Adaptive Learning Agents Workshop](https://alaworkshop2026.github.io) (Monday, May 25): Alex and Roman will present on *Learning social norms of cooperation under limited observability*
...
Or the main conference:
- Wednesday, May 27: Marta Couto will be presenting on *Population Size Effects on Strategic Classification Dynamics* ([paper](https://www.ifaamas.org/Proceedings/aamas2026/pdfs/CKRS7125.pdf))
- Wednesday, May 27: Dimitris Michailidis will present a poster on *Inequality in Congestion Games with Learning Agents* ([paper](https://www.ifaamas.org/Proceedings/aamas2026/pdfs/PRIV8934.pdf))
- Friday, May 29: Martin Smit will present on *Fairness Dynamics in Digital Economy Platforms with Biased Ratings* ([paper](https://www.ifaamas.org/Proceedings/aamas2026/pdfs/CEJT6762.pdf))
